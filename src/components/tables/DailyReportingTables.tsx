...
interface EnhancedTableProps {
    numSelected: number;
    onRequestSort: (event: React.MouseEvent<unknown>, property: keyof DailyStatistics) => void;
...
function EnhancedTableHead(props: EnhancedTableProps) {
    ...
    const createSortHandler =
        (property: keyof DailyStatistics) => (event: React.MouseEvent<unknown>) => {
...
const DailyReportingTable = observer(() => {
    ...
    const handleRequestSort = (
        ...
        property: keyof DailyStatistics,
    ) => {
    ...
    const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
        if (event.target.checked) {
            const newSelected = rows.map((n:DailyStatistics) => n.id);
