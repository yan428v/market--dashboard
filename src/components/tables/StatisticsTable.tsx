...
type StatisticsData = CampaignStatistics | DailyStatistics;
...
const StatisticsTable = observer(({ rows, type, headCells }: StatisticsTableProps) => {
                                    ...
                                    >
                                        ...
                                        {headCells.map((cell) => (
                                            <TableCell key={cell.id} align={cell.numeric ? 'right' : 'left'}>
                                                {cell.id === 'date' ? formattedDate : row[cell.id]}
                                            </TableCell>
                                        ))}
                                    </TableRow>
                                );
        ...
        >
            {numSelected > 0 ? (
                ...
                <Typography sx={{ flex: '1 1 100%' }} variant="h6" id="tableTitle" component="div">
                    {type === 'all' ? 'Аналитика полная' : 'Аналитика по дням'}
                </Typography>
            )}
            {numSelected > 0 ? (
